...
For the first part, we have `$c_0 = 4$`. Since `$n \leq n^2$` for all
`$n \geq 1$`, letting `$c_1 = 42$` gives us `$42n \leq 42n^2$`. Similarly,
since `$1 \leq n^2$` whenever `$n \geq 1$` letting `$c_2 = 512$ gives us
`$512 \leq 512n^2$`.
...
and we have our `$c = c_0 + c_1 + c_2 = 4 + 42 + 512 = 558$`, and by the
definition of ``O(g(n)``, `$4n^2 + 42n + 512$` is `$O(n^2)$`.
